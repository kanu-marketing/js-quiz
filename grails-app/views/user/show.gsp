	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.major}">
				<li class="fieldcontain">
					<span id="major-label" class="property-label"><g:message code="user.major.label" default="Major" /></span>
					
						<span class="property-value" aria-labelledby="major-label"><g:link controller="major" action="show" id="${userInstance?.major?.id}">${userInstance?.major?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="school-label" class="property-label"><g:message code="user.school.label" default="School" /></span>
						...
						<span class="property-value" aria-labelledby="school-label"><g:link controller="school" action="show" id="${userInstance?.school?.id}">${userInstance?.school?.encodeAsHTML()}</g:link></span>
