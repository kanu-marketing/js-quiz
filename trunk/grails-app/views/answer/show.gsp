			...
			<ol class="property-list answer">
				...
				<li class="fieldcontain">
					<span id="answer-label" class="property-label"><g:message code="answer.answer.label" default="Answer" /></span>
						...
						<span class="property-value" aria-labelledby="answer-label"><g:link controller="quizOption" action="show" id="${answerInstance?.answer?.id}">${answerInstance?.answer?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="question-label" class="property-label"><g:message code="answer.question.label" default="Question" /></span>
						...
						<span class="property-value" aria-labelledby="question-label"><g:link controller="quiz" action="show" id="${answerInstance?.question?.id}">${answerInstance?.question?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="user-label" class="property-label"><g:message code="answer.user.label" default="User" /></span>
						...
						<span class="property-value" aria-labelledby="user-label"><g:link controller="user2" action="show" id="${answerInstance?.user?.id}">${answerInstance?.user?.encodeAsHTML()}</g:link></span>
